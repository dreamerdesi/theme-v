...
/*** Waitlist ***/ 
 ...
 document.addEventListener("DOMContentLoaded", function(event) {
    window.waitlisted.start({domain: "vejo.app.waitlisted.co"})
...
/***Loading***/
  ...
  $(window).load(function() {
		...
		$(".se-pre-con").show().delay(5500).fadeOut();
	});

  /*** animation loader***/

var vejo = document.getElementById("lottie");
lottie.loadAnimation({
  container: vejo, // the dom element that will contain the animation
  renderer: 'svg',
  loop: true,
  autoplay: true,
  path: 'https://cdn.shopify.com/s/files/1/2590/5988/t/2/assets/data.json' // the path to the animation json
});


/*** animation loader mobile***/

var vejo_mobile = document.getElementById("lottie_mobile");
lottie.loadAnimation({
  container: vejo_mobile, // the dom element that will contain the animation
  renderer: 'svg',
  loop: true,
  autoplay: true,
  path: 'https://cdn.shopify.com/s/files/1/2590/5988/t/2/assets/data1.json' // the path to the animation json
});
...
$("#farm-hero").on('touchstart click',function( event )  {
    $('html, body').animate({
        scrollTop: $("#farm-hero-arrow").offset().top
    }, 1000);
});

$("#arrow-product").on('touchstart click',function( event )  {
    $('html, body').animate({
        scrollTop: $("#product-arrow-dest").offset().top
    }, 1000);
});
...
/*** hide name on waitlist iframe***/

$(':button').click(function(){
        $("#ember-view ember-text-field").css({"display":"none"});
    });
...
theme.customerTemplates = (function() {
  ...
  $("#waitlist-button").click(function() {
    $('html, body').animate({
        scrollTop: $("#waitlist").offset().top
    }, 2000);
});
